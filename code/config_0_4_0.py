...
def parse_args():
    ...
    parser.add_argument('--prompt_suffix', type=str,
                        default="; minimal 2d vectors; high-contrast outline; lineal color; no watermark; trending on artstation.")
    ...
    letter_ = args.optimized_letter.replace(' ', '-')
